...
define(["require", "exports", "aurelia-framework", "./spinner-service"], function (require, exports, aurelia_framework_1, spinner_service_1) {
    ...
    var SpinnerCustomAttribute = (function () {
        function SpinnerCustomAttribute(element, taskQueue, spinnerService) {
        ...
        SpinnerCustomAttribute.prototype.attached = function () {
            var _this = this;
            this.taskQueue.queueTask(function () { return __awaiter(_this, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.spinnerService.createSpinner(this.element, this)];
                    case 1: return [2 /*return*/, _a.target = _b.sent()];
                }
            }); }); });
        };
        SpinnerCustomAttribute.prototype.showChanged = function (newValue) {
