...
var tsProjectES6 = typescript.createProject('./tsconfig.json', {
  typescript: tsc
});
var tsProjectES5 = typescript.createProject('./tsconfig.json', {
  typescript: tsc,
  target: 'es5'
});
var tsProjectAMD = typescript.createProject('./tsconfig.json', {
  typescript: tsc,
  target: 'es5',
  module: 'amd'
});
var tsProjectCJS = typescript.createProject('./tsconfig.json', {
  typescript: tsc,
  target: 'es5',
  module: 'commonjs'
});
var tsProjectSystem = typescript.createProject('./tsconfig.json', {
  typescript: tsc,
  target: 'es5',
  module: 'system'
});
